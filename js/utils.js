import { APEX_CONFIG } from "./config.js";
...
export function formatCurrency(value) {
  return new Intl.NumberFormat(APEX_CONFIG.locale, {
    style: "currency",
    currency: APEX_CONFIG.currency,
...
export function formatDate(value) {
  ...
  return new Intl.DateTimeFormat(APEX_CONFIG.locale, {
    month: "short",
    day: "numeric",
    year: "numeric"
  }).format(date);
